exports.seed = function (knex, Promise)  {
  return knex('recipe_ingredient').del()
    ...
    knex('recipe_ingredient').insert({recipe_id:2, ingredient_id:8, quantity:'1/2 cup', description:'grated cheese'}),
    knex('recipe_ingredient').insert({recipe_id:2, ingredient_id:9, quantity:'1/4 cup', description:'dry crumbs'}),
    knex('recipe_ingredient').insert({recipe_id:2, ingredient_id:10, quantity:'1/4 cup', description:'freshly minced'}),
    knex('recipe_ingredient').insert({recipe_id:2, ingredient_id:11, quantity:'300 grams', description:'hot cooked angel hair'})
      ])
    })
}
